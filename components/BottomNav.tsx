  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 pb-safe">
      ...
      <div className="mx-3 mb-3 sm:mx-4 sm:mb-4">
        <div className="relative overflow-hidden rounded-2xl bg-white/70 dark:bg-brand-surface/70 backdrop-blur-xl border border-slate-200 dark:border-white/10 shadow-2xl transition-colors duration-300">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `relative flex flex-col items-center justify-center flex-1 py-2 px-1 transition-all duration-300 ease-out group ${isActive
                    ? 'text-brand-primary'
                    : 'text-slate-400 dark:text-brand-text-muted hover:text-slate-600 dark:hover:text-brand-text-light'
                  }`
                }
              >
                {({ isActive }) => (
