      ...
      <form className="mt-8 space-y-6" onSubmit={handleEmailLoginSubmit}>
        ...
        <div>
          <button
            type="submit"
            disabled={loading}
            className="w-full flex items-center justify-center gap-x-3 py-3 px-4 rounded-full bg-[#13a4ec] text-white font-bold text-base hover:bg-[#13a4ec]/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-300"
          >
