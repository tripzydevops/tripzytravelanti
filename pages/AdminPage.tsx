    ...
    <div className="flex bg-gray-50 dark:bg-brand-bg min-h-screen">
      ...
      >
        <div className={`p-6 flex items-center ${isCollapsed ? 'justify-center' : 'justify-between'} transition-all duration-300`}>
          {!isCollapsed && <h1 className="text-xl font-bold text-slate-900 dark:text-brand-text-light whitespace-nowrap overflow-hidden">{t('adminDashboard')}</h1>}
                  ...
                  <li key={item.id} className="relative group/tooltip">
                    ...
                    >
                      <div className={`flex items-center ${isCollapsed ? 'justify-center w-full' : 'gap-3'}`}>
                        <span className={`${activeTab === item.id ? 'text-brand-primary' : 'text-slate-400 dark:text-white/40 group-hover:text-slate-600'} flex-shrink-0`}>
                          {item.icon}
                        </span>
        ...
        <div className="p-4 border-t border-gray-200 dark:border-white/5 space-y-2">
          <button
            onClick={() => navigate('/')}
            className={`w-full flex items-center ${isCollapsed ? 'justify-center' : 'gap-3 px-3'} py-2.5 rounded-lg text-sm font-medium text-slate-600 dark:text-gray-300 hover:bg-slate-100 dark:hover:bg-white/5 transition-colors`}
            title="Back to App"
          >
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="md:hidden bg-white dark:bg-brand-surface border-b border-gray-200 dark:border-white/5 px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg font-bold text-slate-900 dark:text-white">Tripzy Admin</h1>
          </div>
