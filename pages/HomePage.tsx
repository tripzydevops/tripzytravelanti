      ...
      <div className="min-h-screen">
        ...
        <section className="relative h-[65vh] min-h-[500px] flex items-center justify-center overflow-hidden z-10">
          ...
          <div className="relative z-10 container mx-auto px-4 text-center animate-fade-in">
            ...
            <div className="max-w-3xl mx-auto relative group">
              ...
              <div className="relative bg-white/70 dark:bg-[#001A33]/70 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-full p-2 shadow-2xl flex items-center transition-all duration-300 focus-within:bg-white dark:focus-within:bg-[#001A33] focus-within:border-gold-500/50">
                ...
                <input
                  ...
                  className="w-full bg-transparent border-none text-slate-900 dark:text-white text-lg placeholder-slate-400 dark:placeholder-slate-500 focus:ring-0 px-2 py-3"
              ...
              {isSearchFocused && recentSearches.length > 0 && (
                <div className="absolute top-full mt-4 w-full bg-white/95 dark:bg-[#001A33]/95 backdrop-blur-xl rounded-2xl shadow-2xl z-20 overflow-hidden border border-slate-200 dark:border-white/10 animate-slide-up">
                    ...
                    {recentSearches.map((term, index) => (
                      <li key={index}>
                        <button
                          ...
                          className="w-full text-left px-6 py-3 flex items-center text-slate-700 dark:text-brand-text-light hover:bg-slate-50 dark:hover:bg-white/5 hover:text-gold-500 transition-colors duration-150 border-b border-slate-100 dark:border-white/5 last:border-0"
                        >
                          <ClockIcon className="w-4 h-4 mr-3 text-slate-400" />
                          {term}
                        </button>
                      </li>
                    ))}
              ...
              {isSearchFocused && suggestions.length > 0 && (
                <div className="absolute top-full mt-4 w-full bg-white dark:bg-brand-surface backdrop-blur-2xl rounded-2xl shadow-2xl z-30 overflow-hidden border border-gold-500/30 animate-slide-up">
                  ...
                  <div className="p-3 grid grid-cols-1 gap-1">
                    {suggestions.map((suggestion, index) => (
                      <button
                        ...
                        className="w-full text-left px-4 py-3 rounded-xl flex items-center text-slate-800 dark:text-brand-text-light hover:bg-gold-500/5 hover:text-gold-500 transition-all duration-200 group"
                      >
                        <Search className="w-4 h-4 mr-3 text-slate-300 group-hover:text-gold-500" />
        ...
        <div className="container mx-auto px-4 py-12 relative z-10">
          ...
          <div className="mb-8 flex items-center justify-center">
            <div className="flex bg-slate-100/50 dark:bg-brand-surface/50 backdrop-blur-md p-1 rounded-2xl border border-slate-200 dark:border-white/10 shadow-lg">
              {[
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-bold transition-all duration-300 ${activeMainTab === tab.id
                    ...
                    : 'text-slate-500 dark:text-brand-text-muted hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/5'
                    }`}
                >
            ...
            {activeMainTab === 'foryou' && (
              <div className="animate-fade-in">
                {user ? (
                  ...
                  <div className="text-center py-20 bg-slate-50 rounded-3xl border border-slate-100 shadow-sm">
                    <SparklesIcon className="w-12 h-12 text-gold-400/30 mx-auto mb-4" />
                    <h3 className="text-xl font-bold text-slate-900 mb-2">{t('loginToUnlock')}</h3>
                    <p className="text-slate-500 dark:text-brand-text-muted mb-6">{t('startExploringForRecommendations')}</p>
