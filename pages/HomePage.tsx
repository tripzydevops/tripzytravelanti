      ...
      <div className="min-h-screen">
        ...
        <section className="relative h-[65vh] min-h-[500px] flex items-center justify-center overflow-hidden z-10">
          ...
          <div className="relative z-10 container mx-auto px-4 text-center animate-fade-in">
            ...
            <div className="max-w-3xl mx-auto relative group">
              ...
              <div className="relative bg-white/70 backdrop-blur-xl border border-slate-200 rounded-full p-2 shadow-2xl flex items-center transition-all duration-300 focus-within:bg-white focus-within:border-gold-500/50">
                ...
                <input
                  ...
                  className="w-full bg-transparent border-none text-slate-900 text-lg placeholder-slate-400 focus:ring-0 px-2 py-3"
              ...
              {isSearchFocused && recentSearches.length > 0 && (
                <div className="absolute top-full mt-4 w-full bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl z-20 overflow-hidden border border-slate-200 animate-slide-up">
                    ...
                    {recentSearches.map((term, index) => (
                      <li key={index}>
                        <button
                          ...
                          className="w-full text-left px-6 py-3 flex items-center text-slate-700 hover:bg-slate-50 hover:text-gold-500 transition-colors duration-150 border-b border-slate-100 last:border-0"
                        >
              ...
              {isSearchFocused && suggestions.length > 0 && (
                <div className="absolute top-full mt-4 w-full bg-white backdrop-blur-2xl rounded-2xl shadow-2xl z-30 overflow-hidden border border-gold-500/30 animate-slide-up">
                  ...
                  <div className="p-3 grid grid-cols-1 gap-1">
                    {suggestions.map((suggestion, index) => (
                      <button
                        ...
                        className="w-full text-left px-4 py-3 rounded-xl flex items-center text-slate-800 hover:bg-gold-500/5 hover:text-gold-500 transition-all duration-200 group"
                      >
        ...
        <div className="container mx-auto px-4 py-12 relative z-10">
            ...
            <div className="mb-16 animate-fade-in-up">
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-3xl font-heading font-bold text-slate-900 tracking-tight drop-shadow-lg">
          ...
          <div className="mb-8 flex items-center justify-center">
            <div className="flex bg-slate-100/50 backdrop-blur-md p-1 rounded-2xl border border-slate-200 shadow-lg">
              {[
                ...
                {user ? (
                  <>
                    <div className="flex items-center gap-3 mb-8">
                      ...
                      <h2 className="text-3xl font-heading font-bold text-slate-900 tracking-tight">{smartPicksTitle}</h2>
                    </div>
                  ...
                  <div className="text-center py-20 bg-slate-50 rounded-3xl border border-slate-100 shadow-sm">
                    ...
                    <p className="text-slate-500 mb-6">{t('startExploringForRecommendations')}</p>
            ...
            {activeMainTab === 'nearby' && (
              <div className="animate-fade-in">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h2 className="text-3xl font-heading font-bold text-slate-900 tracking-tight">{t('nearbyDeals')}</h2>
                </div>
